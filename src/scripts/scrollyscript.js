...
// using d3 for convenience
      ...
      function setup(){
        d3.selectAll("[data-name='Attendance_2017']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2017']").classed('increase_width',false);
...
d3.selectAll("[data-name='Attendance_2018']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2018']").classed('increase_width',false);
        d3.selectAll("[data-name='Legend_2018']").classed('quarter_opacity',true);


d3.selectAll("[data-name='Attendance_2019']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2019']").classed('increase_width',false);
        d3.selectAll("[data-name='Legend_2019']").classed('quarter_opacity',true);


d3.selectAll("[data-name='Attendance_2021']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2021']").classed('increase_width',false);
        d3.selectAll("[data-name='Legend_2021']").classed('quarter_opacity',true);


d3.selectAll("[data-name='Attendance_2022']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2022']").classed('increase_width',false);
        d3.selectAll("[data-name='Legend_2022']").classed('quarter_opacity',true);


d3.selectAll("[data-name='Attendance_2023']").classed('quarter_opacity',true);
        ...
        d3.selectAll("[data-name='Attendance_2023']").classed('increase_width',false);
...
initialHide('Education_2023');
   ...
   fade_in('Education_2023');
      ...
      var stepFunctions = [step_0,step_1,step_2,step_3,step_4,step_5,step_6,step_7,step_8,step_9,step_10,step_11,step_12,step_13,step_14,step_15,step_16,step_17,step_18,step_19,step_20,step_21,step_22,step_23,step_24,step_25,step_26]
